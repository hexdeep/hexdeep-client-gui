...
export interface CreateParam extends S5setParam, DeviceDetail {
    ...
    gms_enable?: number;    //	是否启用GMS服务:0,不启用；1，启用；仅Android 14支持
...
export interface MobileModelDimensions {
...
// 用户上传到主机上的自定义机型文件
export interface MobileModelFile extends MobileModelDimensions {
    name: string;
    path: string;
}
